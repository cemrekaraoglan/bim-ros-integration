...
def create_ifcobject(extrusion_heights, plines, corners):
    ...
    for i, pline in enumerate(plines):
        ...
        input_filename = f'{current_directory}/utils/data/ifc_models/input/panel{i+1}.ifc'

        output_filename = f'{current_directory}/utils/data/ifc_models/output/panel{i+1}.ttl'

        IFC2OWL.convert_2_OWL(input_filename, output_filename)
